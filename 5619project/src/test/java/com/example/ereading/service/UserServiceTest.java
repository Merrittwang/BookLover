...
public class UserServiceTest {
    ...
    public void reg() {
        ...
        try {
            ...
            user.setGender(1);
            user.setEmail("123456@google.com");
            userService.reg(user);
            System.out.println("OK");
    ...
    public void login() {
        ...
        User user = userService.login("kevin99", "123456");
        System.out.println(user);
    }

    @Test
    public void changePassword() {
        userService.changePassword(2,"管理员","321","122");
    }

    @Test
    public void getByUid() {
        //err是为了让输出信息为红色
        System.err.println(userService.getByUid(1).getUsername());
    }
